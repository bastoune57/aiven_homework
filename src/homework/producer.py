'''
This code is inpired from the Aiven article on getting started
with Aiven kafka
...
class Producer:
    ...
    This wrapper handles creating the instance,
    closing and sending messages to topic.
    """

    def __init__(self):
        """! Producer init function.

        it loads kafka configuration settings from config file (default
        host_settings.ini) and create a kafka producer instance
        """
